...
Route::prefix('payment')->namespace('Payment')->middleware(['auth:sanctum','throttle:30,1'])->group(function () {
 ...
 Route::prefix('payment')->namespace('Payment')->group(function () {
        ...
        Route::prefix('razorpay')->namespace('Razerpay')->middleware(['auth:sanctum','throttle:30,1'])->group(function () {
            Route::post('create-order','RazerpayController@createOrder');
            Route::post('verify-payment','RazerpayController@verifyPayment');
        });
