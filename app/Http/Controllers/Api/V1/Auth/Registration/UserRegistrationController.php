    ...
    */
    ...
    if ($request->has('mobile') && $request->has('email')) {
      ...
      if ($request->has('mobile'))
        ...
        return response()->json(['success' => true, 'message' => 'User does not exist', 'user_exists' => false, 'action' => 'register', 'mobile' => $mobile]);
      ...
      if ($request->has('email'))
        ...
        return response()->json(['success' => true, 'message' => 'User does not exist', 'user_exists' => false, 'action' => 'register', 'email' => $email]);
      }
